                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-xs-5 col-sm-4 col-lg-6">
                                <br><br><br>
                                <a href="AddStudent.jsp" class="text-uppercase btn btn-dark btn-lg btn-block" role="button">Add New<br></a>
                                <br>
                                <a href="RemoveStudent.jsp" class="text-uppercase btn btn-dark btn-lg btn-block" role="button">Remove<br></a>
                                <br>
                                <a href="ShowStudent.jsp" class="text-uppercase btn btn-dark btn-lg btn-block" role="button">Show</a>
                            </div>
                            <div class="col-xs-1 col-sm-1 col-lg-1"></div>
                            <div class="col-xs-5 col-sm-6 col-lg-4">
                                <br>
                                <br>
                                <img src="../img/student.jpg" style="width:130%; height:100%;" /> 
                            </div>
                        </div>
                    </div>
