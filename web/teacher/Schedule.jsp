        ...
        <div id="wrapper">
            ...
            <div id="content-wrapper">
                ...
                <div class="container-fluid">
                    ...
                    <div class="container">
                        <form class="form-inline mb-2" action="Schedule.jsp" method = "post">
                    ...
                    <div class="card mb-3">
                        ...
                        <form id="submit" action="ScheduleCon.jsp" onsubmit="return validateForm()" method="post"></form>
...
<label class="mr-2" for="year">Year to allot</label>
                           <input type="number" min="2000" max="3000"  class="form-control-sm  mr-5"  name="year" form="submit">
                                ...
                                <input type="submit" class = " btn btn-dark" name="submit" value="submit" form="submit" />
